...
<div class="topnav">
  ...
  <a href="">About</a>
	...
	<div class="topmenu">
				<h1 class="staersti"> Viðburður 4  </h1>
				<h1 class="staersti2">Sestu og spjallaðu við bestu spilara heims.</h1>
	...
	<aside class="aside">
		<div class="insideleft"><img src="represent.jpg" style="width: 100%;height: 100%;"></div>
		<div class="insideright"><h1>Skráning í þennan viðburð:</h1>
			<div class="inputs">
				...
				<input type="hidden" name="event" value="fylgjast með">
