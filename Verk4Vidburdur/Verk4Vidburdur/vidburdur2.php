...
<div class="topnav">
  ...
  <a href="">About</a>
	...
	<div class="topmenu">
				<h1 class="staersti"> Viðburður 2  </h1>
				<h1 class="staersti2">Laugardags lan. verðlaun fyrir fyrsta sæti.</h1>
	...
	<aside class="aside">
		<div class="insideleft"><img src="huge.jpg" style="width: 100%;height: 100%;"></div>
		<div class="insideright"><h1>Skráning í þennan viðburð:</h1>
			<div class="inputs">
				...
				<input type="hidden" name="event" value="Laugardags lan">
